...
Mat imgHSV, mask;
int hmin = 132, smin = 168, vmin = 120;
int hmax = 179, smax = 236, vmax = 236; 
...
int main(){
    Mat img = imread("D:/Vscode_OpenCV/Resources/yellow_line.png");
...
// int main()
// {
//     string path = "D:/Vscode_OpenCV/Resources/track_video.mp4";
